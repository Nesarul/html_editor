...
-- Dumping database structure for drew
CREATE DATABASE IF NOT EXISTS `drew` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `drew`;
...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  `c_footer` text DEFAULT NULL,
  `footer_caption` varchar(255) DEFAULT NULL,
  `c_css` text DEFAULT NULL,
  `c_js` text DEFAULT NULL,
...
-- Dumping data for table drew.sort_unit: ~0 rows (approximately)
...
-- Dumping structure for table drew.unit
CREATE TABLE IF NOT EXISTS `unit` (
  ...
  `unit_contents` longtext DEFAULT NULL,
...
-- Dumping data for table drew.unit: ~0 rows (approximately)
...
-- Dumping structure for table drew.users
...
-- Dumping structure for table drew.user_type
...
-- Dumping data for table drew.user_type: ~3 rows (approximately)
