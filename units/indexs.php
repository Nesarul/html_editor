                ...
                <div class="p-3" style="background-color:white">
                    <div class="table-responsive">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT u.unit_id, u.unit_name,u.course_id, c.course_name FROM unit AS u LEFT OUTER JOIN course AS c ON c.course_id = u.course_id WHERE unit_status = '0' AND unit_sme = ? ORDER BY c.course_name asc";
                                    $p=0;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="../course/read_course.php?id=<?php echo $e->unit_id; ?>&course=<?php echo $e->course_id; ?>" class="btn btn-outline-success btn-sm"><i class="fas fa-edit"></i></a>
